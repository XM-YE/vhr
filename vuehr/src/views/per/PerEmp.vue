                    ...
                    <el-row style="margin-top: 10px">
                        <el-col :span="5">
                            ...
                            <el-popover
                                ...
                                <div slot="reference"
                                     style="width: 120px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box;margin-left: 3px"
        ...
        <div style="margin-top: 10px">
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="showEditEmpView(scope.row)" style="padding: 10px" size="mini">编辑</el-button>
                        <el-button @click="deleteEmp(scope.row)" style="padding: 10px" size="mini" type="danger">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
                    ...
                    <el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item label="政治面貌:" prop="politicId">
                                <el-select v-model="emp.politicId" placeholder="政治面貌" size="mini" style="width: 180px;">
                                    <el-option
                                            v-for="item in politicsstatus"
                                            :key="item.id"
                                            :label="item.name"
        ...
        methods: {
            ...
            deleteEmp(data) {
                this.$confirm('此操作将永久删除【' + data.name + '】, 是否继续?', '提示', {
                    ...
                    this.postKeyValueRequest('/employee/basic/'+data.name).then(resp=>{
                        if(resp){
                            this.initEmps();
                        }
                    })
